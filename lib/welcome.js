...
const genSVG = async ({
	wid = '',
	pp = join(src, 'https://i.ibb.co/F3rhjBN/Add-Text-05-22-10-21-04.jpg'),
	title = '',
	name = '',
	text = '',
	background = ''
...
const render = async ({
	wid = '',
	pp = toBase64(readFileSync(join(src, 'https://i.ibb.co/F3rhjBN/Add-Text-05-22-10-21-04.jpg')), 'image/png'),
	name = '',
	title = '',
	text = '',
